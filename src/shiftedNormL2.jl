...
mutable struct ShiftedNormL2{
  ...
  function ShiftedNormL2(
    ...
    sol = similar(xk)
    J!(A,xk+sj)
    new{R, typeof(xk), typeof(sj),typeof(c),typeof(J!),typeof(A), typeof(sol)}(h, xk, sj, c,J!,A, sol, shifted_twice)
  end
end


shifted(h::NormL2{R}, xk::AbstractVector{R}, c::Function,J!::Function,A::AbstractMatrix{R}) where {R <: Real} =
  ShiftedNormL2(h, xk, zero(xk), c, J!,A, false)
shifted(
  ψ::ShiftedNormL2{R, V0, V1, V2, V3, V4, V5},
  sj::AbstractVector{R},
) where {R <: Real, V0 <: AbstractVector{R}, V1 <: AbstractVector{R}, V2 <: Function, V3 <: Function, V4 <: AbstractMatrix{R},V5<: AbstractVector{R}} =
  ShiftedNormL2(ψ.h, ψ.xk,sj, ψ.c , ψ.J!,ψ.A, true)
